...
class EmpsControllerTest < ActionController::TestCase
  ...
  test "should create emp" do
    assert_difference('Emp.count') do
      post :create, emp: { age: @emp.age, company_id: @emp.company_id, email: @emp.email, name: @emp.name }
    end
  ...
  test "should update emp" do
    patch :update, id: @emp, emp: { age: @emp.age, company_id: @emp.company_id, email: @emp.email, name: @emp.name }
    assert_redirected_to emp_path(assigns(:emp))
  end
